...
MODEL              = robot
MODULES            = robot_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE           = robot.mk
...
MASTER_ANCHOR_DIR  = 
START_DIR          = D:\Projects\SERTS\Body\v5.0\Matlab\Robot
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\accel\robot
