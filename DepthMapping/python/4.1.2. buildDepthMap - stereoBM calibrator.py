...
blockSize = [11]
minDisparities = [0]
numDisparities = 16 - int(minDisparities[0])
uniquessRatio = [0]
speckleRange = [0]
speckleWindow = [0]
...
while (True):
    ...
    left_matcher = cv2.StereoBM_create(numDisparities, int(blockSize[0]))
    left_matcher.setMinDisparity(int(minDisparities[0]))
    ...
    cvui.trackbar(frame, 25, 140, 600, minDisparities, -96, 96, 16, '%.1Lf', cvui.TRACKBAR_DISCRETE, 16)
